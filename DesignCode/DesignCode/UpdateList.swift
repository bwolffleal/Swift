...
//  DesignCode
//
//  Created by Bernardo Leal on 02/12/21.
//
                        ...
                        HStack {
                            ...
                            VStack(alignment: .leading, spacing: 8.0) {
                                ...
                                Text(update.text)
                                    .lineLimit(2)
                                    .font(.subheadline)
                                    .foregroundColor(Color(red: 0.369, green: 0.354, blue: 0.382))
...
let updateData = [
    Update(image: "Card1", title: "SwiftUI Advanced", text: "Take your SiftUI app to the App Store with advanced techniques like API data, packages and CMS.", date: "JAN 1"),
